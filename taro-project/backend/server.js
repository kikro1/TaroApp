...
- пиши только на русском языке, без английских слов, латиницы и случайных иностранных вставок;
- следи за грамматикой: фразы должны звучать естественно для русскоязычного читателя;
  ...
  try {
    ...
    try {
      const response = await getClient().chat.completions.create({
        model: MODEL,
        temperature: 0.55,
        max_tokens: Math.min(4200, 900 + positions.length * 450),
        messages: [
          {
            role: "user",
            content: prompt,
